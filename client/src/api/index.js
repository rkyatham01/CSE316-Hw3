...
export const addPlaylist = () => api.post('/playlist',{name: "Untitled", songs: []})
export const removePlaylist = (id) => api.delete(`/playlist/${id}`)

export const updatePlaylistById = (id, playlist) => api.post(`/playlist/${id}`,playlist);
export const updatePlaylistAddSong = (id, playlist) => api.post(`/playlist/${id}`, playlist);
